...
const INSTRUCTIONS: [(&str, Op); 256] = [
    ...
    // 0x4x
    unimpl_opcode!(0x40 LD B,B14- - - -),
    unimpl_opcode!(0x41 LD B,C14- - - -),
    unimpl_opcode!(0x42 LD B,D14- - - -),
    unimpl_opcode!(0x43 LD B,E14- - - -),
    unimpl_opcode!(0x44 LD B,H14- - - -),
    unimpl_opcode!(0x45 LD B,L14- - - -),
    unimpl_opcode!(0x46 LD B,(HL)18- - - -),
    unimpl_opcode!(0x47 LD B,A14- - - -),
    unimpl_opcode!(0x48 LD C,B14- - - -),
    unimpl_opcode!(0x49 LD C,C14- - - -),
    unimpl_opcode!(0x4A LD C,D14- - - -),
    unimpl_opcode!(0x4B LD C,E14- - - -),
    ...
    unimpl_opcode!(0x52 LD D,D14- - - -),
    unimpl_opcode!(0x53 LD D,E14- - - -),
    unimpl_opcode!(0x54 LD D,H14- - - -),
    unimpl_opcode!(0x55 LD D,L14- - - -),
    unimpl_opcode!(0x56 LD D,(HL)18- - - -),
    unimpl_opcode!(0x57 LD D,A14- - - -),
    unimpl_opcode!(0x58 LD E,B14- - - -),
    unimpl_opcode!(0x59 LD E,C14- - - -),
    unimpl_opcode!(0x5A LD E,D14- - - -),
    unimpl_opcode!(0x5B LD E,E14- - - -),
    unimpl_opcode!(0x5C LD E,H14- - - -),
    unimpl_opcode!(0x5D LD E,L14- - - -),
    unimpl_opcode!(0x5E LD E,(HL)18- - - -),
    unimpl_opcode!(0x5F LD E,A14- - - -),
    // 0x6x
    unimpl_opcode!(0x60 LD H,B14- - - -),
    unimpl_opcode!(0x61 LD H,C14- - - -),
    unimpl_opcode!(0x62 LD H,D14- - - -),
    unimpl_opcode!(0x63 LD H,E14- - - -),
    unimpl_opcode!(0x64 LD H,H14- - - -),
    unimpl_opcode!(0x65 LD H,L14- - - -),
    ("LD h, (hl)", loads::ld_h_ptr_hl),
    unimpl_opcode!(0x67 LD H,A14- - - -),
    unimpl_opcode!(0x68 LD L,B14- - - -),
    unimpl_opcode!(0x69 LD L,C14- - - -),
    unimpl_opcode!(0x6A LD L,D14- - - -),
    unimpl_opcode!(0x6B LD L,E14- - - -),
    unimpl_opcode!(0x6C LD L,H14- - - -),
    unimpl_opcode!(0x6D LD L,L14- - - -),
    unimpl_opcode!(0x6E LD L,(HL)18- - - -),
    unimpl_opcode!(0x6F LD L,A14- - - -),
    // 0x7x
